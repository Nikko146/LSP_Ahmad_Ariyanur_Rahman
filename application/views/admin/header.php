  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?php echo base_url(); ?>assets/adminlte/index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Si Surat Poliban</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php
            $menu_master1 = array('surat_masuk', 'surat_masuk_detil', 'surat_masuk_tambah', 'surat_masuk_edit');
            $menu_master2 = array('surat_keluar', 'surat_keluar_detil', 'surat_keluar_tambah', 'surat_keluar_edit');
            ?>
            <li class="nav-item  
              <?php
            ...
            ">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo base_url('admin/surat_masuk'); ?>" class="nav-link
                    <?php
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url('admin/surat_keluar'); ?>" class="nav-link
                    <?php
